                    ...
                    <div className="row">
                            ...
                            <div className="vl-footer-widget-1">
                                ...
                                <div className="vl-footer-content">
                                    <p className="pt-24 pb-24">
                                        Eduka je udruženje zdravstvenih radnika Nišavskog okruga posvećeno razvoju
                                        stručnih kompetencija, kontinuiranoj edukaciji i unapređenju zdravstvene zaštite.
                                    </p>
                                </div>
                            ...
                            <div className="vl-footer-widget-2">
                                ...
                                <div className="vl-footer-menu">
                                    <ul>
                                        ...
                                        <li>
                                            <Link href="/service">Akreditovane edukacije</Link>
                                        </li>
                                        <li>
                        ...
                        <div className="col-lg-2 col-md-6 mb-30">
                            <div className="vl-footer-widget-3 ml-40">
                                <h3 className="vl-footer-widget-title mb-24">Programi</h3>
                                <div className="vl-footer-menu">
                                    <ul>
                                        <li>
                                            <Link href="/service">Seminari uživo</Link>
                                        </li>
                                        <li>
                                            <Link href="/service-left">Online obuke</Link>
                                        </li>
                                        <li>
                                            <Link href="/service-right">Radionice</Link>
                                        </li>
                                        <li>
                                            <Link href="/blog">Vesti i stručni tekstovi</Link>
                                        </li>
                                        <li>
                                            <Link href="/contact">Podrška članovima</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="vl-footer-copyright-text">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p className="para">© {new Date().getFullYear()} Udruženje Eduka. Sva prava zadržana.</p>
                            </div>
                            <div className="col-lg-6 col-md-6">
