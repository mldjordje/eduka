  ...
  return (
    <>
            ...
            <div className="col-lg-4 col-md-6 mb-30">
              ...
              <div className="vl-contact-iner-icon-box">
                ...
                <div className="content">
                  ...
                  <Link href="tel:+381184261749">018 426 1749 (Mišića)</Link> <br />
                  <Link href="tel:+381638661256">063 866 1256 (Tankosića)</Link> <br />
            ...
            <div className="col-lg-4 col-md-6 mb-30">
              ...
              <div className="vl-contact-iner-icon-box">
                ...
                <div className="content">
                  ...
                  <div className="pt-10">
                    <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="mr-12"><i className="fa-brands fa-facebook-f" /></a>
                    <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-instagram" /></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="vl-map-area pb-100">
        <div className="container">
          <iframe title="Vojvode Mišića 50" src="https://www.google.com/maps?q=Vojvode%20Mi%C5%A1i%C4%87a%2050%2C%20Ni%C5%A1&output=embed" className="vl-maps mb-20" />
          <iframe title="Vojvode Tankosića 15" src="https://www.google.com/maps?q=Vojvode%20Tankosi%C4%87a%2015%2C%20Ni%C5%A1&output=embed" className="vl-maps" />
        </div>
      </div>
    </>
  );
