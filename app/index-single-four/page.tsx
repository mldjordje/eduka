...
export default function Home() {
  return (
    <>
      <Layout headerStyle={4} footerStyle={4} offcanvas_bg="vl-offcanvas-bg-4" offcanvas_menu="vl-offcanvas-menu-4" offcanvas_social="vl-footer-socia4l" mainMenuStyle="one-page">
        <Section1 />
        <Section2 />
        <Section3 />
        <Section4 />
